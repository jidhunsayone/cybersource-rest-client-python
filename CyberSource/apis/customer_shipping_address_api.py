...
class CustomerShippingAddressApi(object):
    ...
    def delete_customer_shipping_address_with_http_info(self, customer_token_id, shipping_address_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{}/shipping-addresses/{}'.format(customer_token_id, shipping_address_token_id), 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_customer_shipping_address_with_http_info(self, customer_token_id, shipping_address_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{}/shipping-addresses/{}'.format(customer_token_id, shipping_address_token_id), 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_customer_shipping_addresses_list_with_http_info(self, customer_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{}/shipping-addresses'.format(customer_token_id), 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_customers_shipping_address_with_http_info(self, customer_token_id, shipping_address_token_id, patch_customer_shipping_address_request, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{}/shipping-addresses/{}'.format(customer_token_id, shipping_address_token_id), 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_customer_shipping_address_with_http_info(self, customer_token_id, post_customer_shipping_address_request, **kwargs):
        ...
        return self.api_client.call_api('/tms/v2/customers/{}/shipping-addresses'.format(customer_token_id), 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
