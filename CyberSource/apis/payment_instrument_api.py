...
class PaymentInstrumentApi(object):
    ...
    def delete_payment_instrument_with_http_info(self, payment_instrument_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{}'.format(payment_instrument_token_id), 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_payment_instrument_with_http_info(self, payment_instrument_token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{}'.format(payment_instrument_token_id), 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_payment_instrument_with_http_info(self, payment_instrument_token_id, patch_payment_instrument_request, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{}'.format(payment_instrument_token_id), 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
